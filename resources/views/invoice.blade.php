...
@section('content')
    ...
    <div class="main-content">
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title me-3" id="paymentModalLabel">Payment for INV</h5>
                        <!-- Use the 'me-3' class for margin-end -->
                    ...
                    <form method="POST" action="{{ URL('modelVoucherSave') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-0 row">
                                <label for="amountReceived" class="col-md-2 col-form-label fw-bold">Amount Received
                                    (AED)</label>
                                <div class="col-md-4">
                                    <input class="form-control" required="" type="number" id="amountReceived"
                                        name="amount_received" value="" step="0.01">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4" id="vhno" readonly>
                                    e
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="modelClose" type="button" class="btn btn-outline-secondary"
        ...
        <div class="modal fade" id="pdfViewModal" tabindex="-1" aria-labelledby="pdfViewModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a title="" class="btn btn-danger" id="print" onclick="printInvoice()">Print</a>
        ...
        <!-- Modal for Payment Form -->
        <div class="modal fade" id="partyledgermodal" tabindex="-1" aria-labelledby="paymentModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-top">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5>
                            <div id="modal-title">Party Ledger</div>
                        </h5> <!-- Use the 'me-3' class for margin-end -->
                        <div><span id="invoiceType" class="badge bg-danger pl-3"></span></div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
            ...
            function printInvoice() {
                ...
                frameDoc.write(`
                    ...
                    <head>
                        <title>Invoice</title>
                        <style>
                            /* Optional: copy your main CSS here if needed */
            ...
            function openInvoiceModal(invoiceMasterID) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#amountReceived').val('');
                        $('#bankCharges').val(parseFloat(response.BankCharges).toFixed(2));
                        $('#paymentDate').val('');
                        $('#paymentMode').val('');
                        $('#deposit-to').val('');
                        $('#voucherNumber').val('');
                        ...
                        $('#notes').val('Payment Received Against Invoice ' + response.InvoiceMasterID);
        ...
        <script>
            $(document).ready(function() {
                ...
                // call from three dosts menu to record payment     
                $(document).on('click', '.record-payment', function(e) {

                    e.preventDefault();

                    const invoiceMasterID = $(this).data('invoicemasterid');
                ...
                function getAccountsCategory(selectedMode) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            depositToSelect.empty();
                            response.forEach(function(account) {
                                depositToSelect.append('<option value="' + account
                                    .ChartOfAccountID + '" data-account-name="' + account
                                    .ChartOfAccountName + '">' + account.ChartOfAccountID +
                                    ' - ' + account.ChartOfAccountName + '</option>');
                            });
                ...
                $('#payment-mode').change(function() {
                    ...
                    if (selectedMode !== '') {
                        ...
                        $('#deposit-to').append(
                            '<option value="">Select an option</option>'); // Add a default option back
                    }
