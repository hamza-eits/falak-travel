                         ...
                         <div class="col-12">
                          <div class="mb-1 row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="text" name="Source" id="Source" value="{{ $invoice_mst[0]->Source }}" class="form-control">
                            </div>
...
<option value="Ras Al-Khaimah" {{ ('Ras Al-Khaimah' == $value1->PickPoint) ? 'selected=selected' : '' }}>Ras Al-Khaimah</option>
                            ...
                            <td>
                               <input type="number" name="ItemTotal[]" id="Total_{{$no}}" class=" form-control changesNo "
...
<label for="PassportFile_1" class="fw-bolder">Nationality</label>
                              <select name="Nationality[]" id="Nationality_{{$no}}" class="form-select select2">
                                <option value="">choose</option>
                                @foreach ($nationality as $row)
                                  <option value="{{ $row->country_enNationality }}" {{($row->country_enNationality== $value1->Nationality) ? 'selected=selected':'' }}
                                  >{{ $row->country_enNationality }}</option>
                                @endforeach
                              </select>
                              </div>
                            </td>
  ...
  <div class="row">
    ...
    <div class="col-md-4"> 
      <select name="BankName" class="form-select">
       ...
       <option value="Nomod" {{ $invoice_mst[0]->BankName == 'Nomod' ? 'selected' : '' }}>Nomod</option>
<option value="Tabbay" {{ $invoice_mst[0]->BankName == 'Tabbay' ? 'selected' : '' }}>Tabbay</option>
<option value="Tamara" {{ $invoice_mst[0]->BankName == 'Tamara' ? 'selected' : '' }}>Tamara</option>
    ...
    <div class="col-md-4">
      <div class="input-group">
        <input type="number" name="Percentage" class="form-control" placeholder="%" step="0.01" min="0" max="100" value="{{ number_format($invoice_mst[0]->Percentage,2) }}" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
    ...
    <div class="col-md-4">
      <div class="input-group">
        ...
        <input type="number" name="PercentageValue" id="PercentageValue" class="form-control" step="0.01" placeholder="Amount"
          onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{ number_format($invoice_mst[0]->BankCharges,2) }}">
      </div>
    </div>
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="GrandTotal" id="GrandTotal"
                          ...
                          onpaste="return false;" step="0.01" value="{{ $invoice_mst[0]->GrandTotal }}">
                      </div>
                    </div> 
                        </div>
