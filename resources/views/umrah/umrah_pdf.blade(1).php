...
$total=$total + $value->Paid;
 ...
 ?>
  ...
  <tr >
    ...
    <td   valign="bottom" align="center">{{number_format($value->Taxable,2)}}<br>  {{($value->Taxable>0) ? '5.00%' : '' }} </td>
...
@endforeach
  ...
  <tr>
    <td colspan="8"><table width="50%" border="0" align="right" >
      ...
      <tr>
        <td height="20" align="right" style="padding-right: 25px;"><strong>Bank Charges</strong></td>
        <td height="20"><strong>AED{{number_format($invoice_mst[0]->BankCharges,2)}}</strong></td>
      </tr>
      
      
      <tr>
        <td height="20" align="right" style="padding-right: 25px;"><strong>Grand Total</strong></td>
        <td height="20"><strong>AED{{number_format($invoice_mst[0]->GrandTotal ?? $invoice_mst[0]->Total,2)}}</strong></td>
      </tr>
      <tr>
        ...
        <tr  >
        <td height="20" align="right" style="padding-right: 25px;"><strong>Payment Mode</strong> </td>
        <td height="20"><strong>{{$invoice_mst[0]->PaymentMode}}</strong></td>
      </tr>

        <tr  >
        <td height="20" align="right" style="padding-right: 25px;"><strong>Payment in bus</strong> </td>
        <td height="20"><strong>{{number_format($invoice_det->sum('PaymentInBus'))}}</strong></td>
      </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr style="background-color: #333333; color: white;"  >
    <td  height="25" scope="col" align="left" width="50%" style="padding-left: 10px;" >Vat Detail </td>
