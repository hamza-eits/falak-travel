                            ...
                            <div class="page-title-right">
                                <div class="page-title-right">
                                    <form action="{{ URL('/UmrahReport1') }}" method="post" name="form1" id="form1"
                                                ...
                                                <select name="UserID" id="UserID" class="form-select">
                                                    ...
                                                    @foreach ($users as $value)
                                                        <option value="{{ $value->UserID }}"
                                                            {{ request()->UserID == $value->UserID ? 'selected=selected' : '' }}>
                                                ...
                                                <select name="ItemID" id="ItemID" class="form-control">
                                                    ...
                                                    @foreach ($item as $value)
                                                        <option value="{{ $value->ItemID }}"
                                                            {{ request()->ItemID == $value->ItemID ? 'selected=selected' : '' }}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group mx-2 ">
                                                ...
                                                <select name="Type" id="Type" class="form-control">
                                                    <option value="Date"
                                                        {{ request()->Type == 'Date' ? 'selected=selected' : '' }}>Invoice
                                                        Date</option>
                                                    <option value="DepartureDate"
                                                        {{ request()->Type == 'DepartureDate' ? 'selected=selected' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mx-2">
                                                <label for="">From Date</label> <input type="date"
                                                    class="form-control" id="EndDate" name="StartDate"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mx-2">
                                                <label for="">Till Date</label> <input type="date"
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ URL('/UmrahReport1PDF') . '/' . $supplier->SupplierID . '/' . request()->StartDate . '/' . request()->EndDate . '/' . request()->Type . '/' . request()->ItemID }}">
                                                                <i class="mdi mdi-file-pdf-outline label-icon"></i> Export
                                                                PDF
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ URL('/UmrahReport2PDF') . '/' . $supplier->SupplierID . '/' . request()->StartDate . '/' . request()->EndDate . '/' . request()->Type . '/' . request()->ItemID }}">
                                                                <i class="mdi mdi-file-pdf-outline label-icon"></i> For
                                                                Vendor
                                                            </a>
                                                        </li>
                                                    </ul>
                                        ...
                                        <tbody>
                                            @foreach ($invoice_detail as $key => $invoice_detail)
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"><a
                                                            href="{{ URL('/UmrahPDF/') . '/' . $invoice_detail->InvoiceMasterID }}"
                                                            target="_blank">{{ $invoice_detail->InvoiceMasterID }}</a>
                                                    </td>
                                                    ...
                                                    <td align="center">{{ $invoice_detail->Nationality }}</td>
                                                    ...
                                                    <td align="center">{{ dateformatman($invoice_detail->DepartureDate) }}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ number_format($invoice_detail->UmrahFare, 2) }}</td>
                                                    <td class="text-center">{{ number_format($invoice_detail->Fare, 2) }}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ number_format($invoice_detail->Service, 2) }}</td>
                                                    <td class="text-center">
                                                        {{ number_format($invoice_detail->Taxable, 2) }}</td>
                                                    <td class="text-center">{{ number_format($invoice_detail->Total, 2) }}
                                                    </td>
                                                    <td class="text-center">{{ number_format($invoice_detail->Paid, 2) }}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ number_format($invoice_detail->PaymentInBus, 2) }}</td>
                                                </tr>
                                            @endforeach
