                            ...
                            <button type="button" class="  btn btn-outline-light dropdown-toggle"
                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                    class=" text-success far fa-bookmark
                                        font-size-16 align-middle me-2"></i>Favourite
                 ...
                 <a class="dropdown-item" href="#">Party Analysis</a> -->
                        ...
                        <div class="btn-group d-none d-lg-inline-block">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ URL('/SalemanTicketRegister') }}">Saleman Ticket
                                    Register</a>

                                <a class="dropdown-item" href="{{ URL('/SalemanInvoiceBalance') }}">Saleman Invoice
                                    Balances</a>
